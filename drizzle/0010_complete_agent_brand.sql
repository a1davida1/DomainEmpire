...
UPDATE "review_tasks" SET "confidence_thresholds" = '{}'::jsonb WHERE "confidence_thresholds" IS NULL;--> statement-breakpoint
ALTER TABLE "review_tasks" ALTER COLUMN "confidence_thresholds" SET NOT NULL;--> statement-breakpoint
...
ALTER TABLE "review_tasks" ADD CONSTRAINT "review_tasks_auto_action_check" CHECK (
    "auto_approve_after_hours" IS NULL OR "auto_reject_after_hours" IS NULL
