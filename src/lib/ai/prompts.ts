...
`,
     ...
     */
    article: (outline: object, keyword: string, domainName: string, voiceSeed?: VoiceSeed) => `
...
FACTUAL CONTENT:
- Include specific numbers, dates, and data points. Not rounded. "$437/month" not "around $400/month."
- Reference specific real brands, companies, products, studies by name. Generality is an AI tell.
- Include at least one "I checked and..." or "According to [specific source]" per article.
- Mention at least one thing that's slightly surprising or counterintuitive. Humans find and share unexpected findings. AI summarizes the expected.
...
`,
     ...
     */
    comparison: (outline: object, keyword: string, domainName: string) => `
...
2. INPUT SECTION
   ...
   - Smart defaults pre-filled (national averages or most common values)
...
`,
     ...
     */
    costGuide: (outline: object, keyword: string, domainName: string) => `
...
`,
     ...
     */
    leadCapture: (outline: object, keyword: string, domainName: string) => `
...
`,
     ...
     */
    healthDecision: (outline: object, keyword: string, domainName: string) => `
